    ...
    sections: [
      ...
      },
      {
        ...
        steps: [
          ...
          "De qualquer tela, também dá para pedir um rascunho de post para o blog (ex.: \"escreve um post sobre alimentação saudável na gestação\"). Ele escreve título, resumo, conteúdo em Markdown, categoria e tags, sempre como RASCUNHO — nunca publica sozinho. Revise e publique na tela do blog quando estiver pronto.",
