  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        steps: [
          "Na primeira vez que você entra no dashboard em cada dia, o assistente abre sozinho com um resumo do dia: consultas de hoje, pacientes novos cadastrados, pré-consultas recebidas e tarefas com prazo para hoje. Isso não usa IA (é só uma consulta direta aos dados), então funciona mesmo sem chave de IA configurada — as demais funções do chat continuam dependendo da chave.",
          ...
          "De qualquer tela, diga o que precisa fazer (ex.: \"vou atender a Fulana agora\", \"abre o cliente Beltrano\", \"abre a agenda\") e o assistente navega sozinho até a tela certa — se houver mais de um cliente com nome parecido, ele pergunta qual antes de abrir. Se você já disser qual parte da ficha quer ver (ex.: \"abre a antropometria do Fernando\"), ele abre direto na aba certa (Resumo, Anamnese, Antropometria, Plano alimentar ou Evolução), sem precisar clicar em nada depois.",
          "Também dá para perguntar coisas com dados reais em vez de só pedir para abrir a tela: \"quais as oportunidades que eu tenho hoje\", \"tem lead quente parado?\", \"como está o financeiro\", \"quantos protocolos ativos eu tenho\", \"tem tarefa atrasada?\". Ele consulta os números e a lista de oportunidades de verdade antes de responder.",
          ...
          "Também na ficha do cliente, ele sabe as próximas consultas já marcadas e pode propor uma consulta nova (ex.: \"marca uma consulta pro Fernando semana que vem às 14h\") ou uma tarefa de acompanhamento (ex.: \"cria uma tarefa pra eu ligar pra ela\") — sempre com data calculada a partir de hoje e revisão antes de confirmar. Ele não verifica conflito de horário sozinho, então vale conferir a agenda quando o horário for incerto.",
