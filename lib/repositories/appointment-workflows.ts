...
export async function ensureAppointmentWorkflowTable() {
  await d1Execute(
  ...
  await d1Execute(
    "CREATE INDEX IF NOT EXISTS idx_appointment_workflows_due_at ON appointment_workflow_items(due_at)"
  );
  await d1Execute(
    "CREATE INDEX IF NOT EXISTS idx_appointment_workflows_status ON appointment_workflow_items(status)"
  );
  await d1Execute(
    "CREATE INDEX IF NOT EXISTS idx_appointment_workflows_appointment_id ON appointment_workflow_items(appointment_id)"
  );
}
